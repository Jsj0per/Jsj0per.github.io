...
---
# 합격까지의 이야기  
13기 모집 원서 사적 : 2024년 10월 21일(월) - 11월 4일(월)  
SW 적성 진단 : 2024년 11월 5일(화) ~ 11월 16일(토)  
...
* 일반 컴퓨터 학원에서 복수전공 보충수업용도로 기본 JAVA반으로 3개월간 받고, 기본 C언어 반으로 3개월 받았다. 졸업 후 취업을 위하여 서울의 대형 컴퓨터 학원 국비교육으로 자바, 스프링 교육을 6개월간 받았고 이후 취업전선으로 뛰어들었으나, 취업에 실패하여 이후부터 SSAFY 도전 시작.  
* 12기 대전 캠퍼스 JAVA 비전공 코스에서 면접 불합격, 13기 구미캠퍼스 Python 비전공 코스로 최종 합격.  
---
# 1주차  
